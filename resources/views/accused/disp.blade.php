      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  ...
                  <div class="back"> <a href="/accused/update" type="botton">Back</a></div>
<form class="form-horizontal" action="/accused/disp" method='POST'>
  {{csrf_field()}}
  <div class="form-group"><br>
    <label class="control-label col-sm-2" >Accused Id:</label>
    <div class="col-sm-10">
