      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  ...
                  <form class="form-horizontal" action="/petitioners/add" method='POST'>
                    {{csrf_field()}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control"  id="age" name="age" placeholder="Enter age" min="1">
                        </div>
                      </div>
                      <div class="form-group">
